...
import databasetracing.queryparsers.sqlserver.ExecQueryParser;
import databasetracing.queryparsers.sqlserver.InlineParameterExecQueryParser;
import databasetracing.queryparsers.sqlserver.SqlQueryParserBuilder;

public class ExecQueryParserTest {
    ...
    public static final String execString = "declare @p1 int\n"
            + "set @p1=773\n"
    ...
    public static final String inlineParameterSqlString = "declare @p1 int\n"
            + "set @p1=1971\n"
            + "exec sp_prepexec @p1 output,NULL,N' SET NOCOUNT ON EXEC SelectFailedWalletServerTransactions @FromDate=''2013-10-15 13:23:34'',  @ToDate=''2013-10-25 13:22:34'',  @RowLimit=''1000'''\n"
            + "select @p1";;


    public ExecQueryParserTest() {

        parser = new ExecQueryParser();
        parser.prepare(execString);
    ...
    public void ShouldGetOperatorOfParser() {
        ...
        Assert.assertEquals("EXEC", operator);
    }


    @Test
    public void shouldBeParsedAsOperator() {
        Assert.assertTrue(parser.prepare(execString));
    }


    @Test
    public void shouldNotBeAbleToParseSelectStatement() {
        QueryParser anotherParser = new ExecQueryParser();
    ...
    public void shouldGetStatementBody() {
        String expected = "WriteTracking @P0,@P1,@P2,@P3,@P4,@P5";
    ...
    public void shouldGetParameterString() {
        ...
        String expected = "33234,9,'2013-10-21 17:12:59.720','2013-10-21 17:12:59',1,N''";
    ...
    public void shouldParserFullStatementThroughQueryBuilder() {
        String actual = SqlQueryParserBuilder.parseQuery(execString);

        String expected = "EXEC WriteTracking 33234,9,'2013-10-21 17:12:59.720','2013-10-21 17:12:59',1,N''";
    ...
    @Test
    public void shouldParseInlineParametersInExecCommand() {
        InlineParameterExecQueryParser inlineParser = new InlineParameterExecQueryParser();
        Assert.assertTrue(inlineParser.prepare(inlineParameterSqlString));

        Assert.assertEquals("EXEC", inlineParser.getOperation());
        Assert.assertEquals("", inlineParser.getParameterStringPart());
        Assert.assertEquals(
                "SelectFailedWalletServerTransactions @FromDate'2013-10-15 13:23:3',  @ToDate'2013-10-25 13:22:3',  @RowLimit'100'",
                inlineParser.getStatementBodyPart());

        String expected = "EXEC SelectFailedWalletServerTransactions @FromDate'2013-10-15 13:23:3',  @ToDate'2013-10-25 13:22:3',  @RowLimit'100'";
        String actual = SqlQueryParserBuilder.parseQuery(inlineParameterSqlString);
